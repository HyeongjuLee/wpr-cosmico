...
<%
	...
	Response.Redirect "/salesman/salesman.asp"

	'디자이너스 BP플래너 조회(CurPoint=60)
...
<div id="pages">
	...
	<div id="salesman">
		<%
			...
			arrList = Db.execRsList("HJPS_SALESMAN_SEARCH_DESIGNUS",DB_PROC,arrParams,listLen,DB3)
...
'						print salesTel
						...
						salesTel = Left(salesTel,salesTelLen-2)

						If salesNa_Code = "" Then salesNa_Code = "KR"

						PRINT TABS(2)& "	<tr class=""for_td"">"
						PRINT TABS(2)& "		<td>"&arrList(0,i)&"</td>"
						PRINT TABS(2)& "		<td>"&arrList(1,i)&"-"&Right("00000000"&arrList(2,i),MBID2_LEN)&"</td>"
				...
				Else
					PRINT TABS(2)& "<tr>"
					PRINT TABS(2)& "<td colspan=""4"" class=""notData"">"&NO_DATA_TXT&"</td>"
					PRINT TABS(2)& "</tr>"
				End If

			%><tr>
				<td colspan="4" class="tright pagertop"><%Call pageListn(PAGE,PAGECOUNT,"sales_pa")%></td>
			</tr>
		</table>
