<table <%=tableatt%> id="board1" class="width100">
	...
	<tfoot>
		<tr>
			...
			<td colspan="4" height="40" class="tright">
				<%
	...
	If NB_isTopNotice = "T" Then
		...
		If IsArray(arrListM) Then
			For m = 0 To listLenM
				...
				PRINT TABS(2)& "		<td class=""subject tweight""><a href=""board_view.asp?bname=notice&amp;num="&arrListM_intIDX&""">"&backword_title(arrListM_strSubject)&"</a></td>"
				PRINT TABS(2)& "		<td class=""tcenter"">"&arrListM_strName&"</td>"
				PRINT TABS(2)& "		<td class=""tcenter"">"&Replace(Left(arrListM_regDate,10),"-",".")&"</td>"
				PRINT TABS(2)& "		<td class=""tcenter"">-</td>"
