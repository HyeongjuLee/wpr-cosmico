	...
	If NB_isTopNotice = "T" Then
		...
		If IsArray(arrListM) Then
			For m = 0 To listLenM
				...
				PRINT TABS(2)& "		<td class=""subject tweight"" colspan=""3""><a href=""board_view.asp?bname=notice&amp;num="&arrListM_intIDX&""">"&backword_title(arrListM_strSubject)&"</a></td>"
	...
	If NB_isTopBestView = "T" Then
		...
		If IsArray(arrListM) Then
			For m = 0 To listLenM
				...
				PRINT TABS(2)& "		<td class=""subject"" style=""font-weight:500;""><a href=""board_view.asp?bname="&strBoardName&"&amp;num="&arrListM_intIDX&""">"&backword_title(arrListM_strSubject)&"</a></td>"
%>
					<td style="height:<%=tdHeight%>px"><span
							   class="starIcon"><i class="fas fa-star <%If arrListM_orderGrade > 0 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrListM_orderGrade > 1 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrListM_orderGrade > 2 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrListM_orderGrade > 3 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrListM_orderGrade > 4 Then%>on<%Else%>off<%End If%>"></i></span
						></td>
<%
				PRINT TABS(2)& "		<td class=""tcenter"">"&num2cur(arrListM_VOTECNT)&"</td>"
		...
		For i = 0 To listLen
			...
			If IsArray(arrList3) Then
				For k = 0 To listLen3
					...
					arrList3_strPic1		= arrList3(21,k)
					arrList3_orderGrade		= arrList3(22,k)
...
%>
				<tr class="table_for">
					...
					<td style="height:<%=tdHeight%>px"><span
							   class="starIcon"><i class="fas fa-star <%If arrList3_orderGrade > 0 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrList3_orderGrade > 1 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrList3_orderGrade > 2 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrList3_orderGrade > 3 Then%>on<%Else%>off<%End If%>"></i></span
						><span class="starIcon"><i class="fas fa-star <%If arrList3_orderGrade > 4 Then%>on<%Else%>off<%End If%>"></i></span
						></td>
					<td style="height:<%=tdHeight%>px"><%=num2cur(arrList3_VoteCnt)%></td>
