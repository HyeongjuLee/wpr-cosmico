...
<title><%=DKCONF_SITE_TITLE%> <%=LNG_MYOFFICE_CHART_03%> by Webpro.kr</title>
...
<style>
.listarea {float:left; position:fixed; top:28px; left:20px;}
.listscroll {max-height:300px; width:420px;overflow:auto;}
.input_text {border:2px solid #ababab; border-right:0px none; border-left: 0px none; width:200px; height:14px; padding-left:4px; padding-top:3px; font-size:11px;}

.listicon {float:left; margin-left:20px;}
</style>
<%
...
<!-- <div class="SearchLayer">
	...
	<div class="innerSearch">
		<form name="chkFrm" action="testTree2.asp" method="post" onsubmit="return false;">
			<img src="<%=IMG%>/tree/tree_search_l.png" width="7" height="21" alt="" class="vmiddle" /><input type="text" name="sname" class="input_text vmiddle" style="" value="" /><img src="<%=IMG%>/tree/tree_search.png" width="80" height="21" alt="" onclick="chkNameSponsor();" class="vmiddle cp" /><a href="T_tree_ss_V3A.asp"><img src="<%=IMG%>/tree/tree_reset.png" width="80" height="21" alt="" class="vmiddle" style="margin-left:3px" /></a></span>
		</form>
	</div>
...
<div class="SearchLayer3">
	<div id="search_wrapAll">
		<!-- <div class="listicon2"><img src="<%=IMG%>/tree/tree_list.png" width="21" height="21" alt="" class="vmiddle" /></div>
			...
			<div id="sList" class="listarea"></div>
			<!-- <div style="float:right; margin-top:4px;margin-right:20px;font-weight:bold;"> <%=LNG_TEXT_TREE_MAX_LEVEL%></div> -->
			<div style="float:left; margin-top:4px;margin-left:20px;font-weight:bold;font-size:16px;"> <%=LNG_MYOFFICE_CHART_01%></div></div>
	</div>
	<div id="zoom2" style="margin-right:10px;">
		<a href="#" onClick="zoomIn();" onKeyPress="zoomIn();"><img src="<%=IMG%>/tree/zoomin.png" alt="확대" usemap="#index_cs" width="30"></a><a href="#" onClick="zoomOut();" onKeyPress="zoomOut();"><img src="<%=IMG%>/tree/zoomout.png" alt="축소" usemap="#index_cs" width="30"></a>
	</div>
</div>
<%
...
'			viewIcons2 = viewImg(IMG_ICON&"/satOnGreen.gif",36,38,"")
			...
			'	innerHTML = innerHTML & "<p "&liClass&">단계 : "&arrList(17,i)&"</p>"
