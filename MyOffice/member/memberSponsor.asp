...
<%
	...
	Response.Redirect "/myoffice/member/member_UnderInfo.asp?sc=s"
%>
...
<%
	SQL = "SELECT [mbid],[mbid2],[M_Name],[Regtime],[hptel],[WebID],[BirthDay],[BirthDay_M],[BirthDay_D],[Sell_Mem_TF] FROM [tbl_memberinfo] WHERE [SAVEID] = ? AND [SAVEID2] = ? ORDER BY [LineCnt]"
	arrParams = Array(_
