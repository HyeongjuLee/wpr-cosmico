	...
	<div class="dialog-layer" id="dialog-layer<%=i%>" title="<%=dialog_title%>" style="display: none; overflow-y: auto;">
		...
		<div class="cleft pay_detail_left" style="<%=pay_detail_left_width%>">
			...
			<table <%=tableatt%>  class="inTable1 width100">
				...
				<tbody>
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_1%></td>
					...
					<%If 1=2 Then%>
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_2%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_3%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_4%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_5%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_6%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_7%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_8%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_9%></td>
					...
					<tr>
						<td class="th"><%=LNG_TEXT_PAY_BONUS02_10%></td>
