...
'		DK_MEMBER_ID2 = 1010749
	...
	'이름->ID
	'PUR_DK_MEMBER_NAME = PUR_DK_MEMBER_WebID
	'L_SAVENAME = L_SAVEWEBID
	'R_SAVENAME = R_SAVEWEBID
%>
			...
			<div class="area_inners">
				...
				<div class="spon_info" style="">
					<div class="clear left_info">
						...
						<div class="addr fon_c"><span class="fon3" style="margin-left:5px;"><%=LNG_TEXT_ALL_OVER%> </span><span class="fon1 red2"><%=num2cur(SUMPV_M)%></span><span class="fon3"> <%=CS_PV%></span></div>
				...
				<div style="margin:0px auto;margin-top:20px; width:80%;">
					...
					<div class="spon_info2 fleft">
						<div class="clear left_info">
							...
							<div class="addr fon_g"><span class="fon2 blue2"><%=num2cur(SUMPV_L)%></span><span class="fon4"> <%=CS_PV%></span></div>
					...
					<div class="spon_info2 fright">
						<div class="clear left_info">
							...
							<div class="addr fon_g"><span class="fon2 blue2"><%=num2cur(SUMPV_R)%></span><span class="fon4"> <%=CS_PV%></span></div>
