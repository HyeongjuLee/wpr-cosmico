...
<head>
<meta charset="utf-8">
<title><%=DKCONF_SITE_TITLE%> <%=LNG_MYOFFICE_CHART_02%> </title>
...
<script type="text/javascript" src="calendar.js?v1"></script>
<script type="text/javascript">
	opener.location.href = '/myoffice/member/memberVote.asp';
</script>
<link rel="stylesheet" href="T_tree_ss_V10.css?v=<%=v%>"><%'ss vt 공통%>
...
<div class="SearchLayer2">
	<div id="search_wrap">
		...
		<div id="search_period" class="cleft" style="<%=SEARCHCSS%>">
			<form name="sfrm" action="T_tree_vt_v11.asp" method="post">
				...
				<strong><%=LNG_TEXT_START_DATE%> </strong><input type='text' name='toStartDate' value="<%=toStartDate%>" class='readonly input_text tcenter' size='10' onclick="openCalendar(event, this, 'YYYY-MM-DD');" readonly="readonly">
				~
				<strong><%=LNG_TEXT_END_DATE%> </strong><input type='text' name='toEndDate' value="<%=toEndDate%>" class=' input_text readonly tcenter' size='10' onclick="openCalendar(event, this, 'YYYY-MM-DD');" readonly="readonly">
	...
	<!--<div id="zoom" style="margin-right:10px;">
		<a href="#" onClick="zoomIn();" onKeyPress="zoomIn();"><img src="tree/zoomin.png" alt="<%=LNG_TEXT_ENLARGEMENT%>" usemap="#index_cs" ></a>
		<a href="#" onClick="zoomOut();" onKeyPress="zoomOut();"><img src="tree/zoomout.png" alt="<%=LNG_TEXT_REDUCTION%>" usemap="#index_cs" ></a>
	</div>
		...
		For i = 0 To listLen
			...
			If i = 0 Then
				...
				Else
					...
					PRINT viewP_cCenter & viewP_cSaveInfo_1 & viewP_cSaveInfo_2 &  viewP_cPeriodCV & viewP_cPeriodDownPV & viewP_cPeriodDownCV & viewP_cGrade & viewP_cCPoint
		...
		<div class="modal-dialog modal-dialog-scrollable" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<!-- <div class="underPV2">
						<h6 style="border-bottom:1px dashed #dee2e6; padding-bottom:7px;"><%=LNG_TEXT_TOTAL_SALES_OF_UNDER_MEMBER%> - 후원 (이월)</h6>
						<div style="text-align:center;">
