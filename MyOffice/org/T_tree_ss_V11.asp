...
<head>
<meta charset="utf-8">
<title><%=DKCONF_SITE_TITLE%> <%=LNG_MYOFFICE_CHART_01%> </title>
...
<!--#include file = "T_tree_ss_V11.js.asp"--><%'JS%>
<%
...
'	PRINT SDK_MEMBER_ID2
	...
	cNomInfo		= Request("cNomInfo")			'Nom Info
...
<div class="SearchLayer2">
	<div id="search_wrap">
		<div class="cleft">
			<a href="T_tree_ss_V11.asp" class="a_submit design4"><%=LNG_TEXT_INITIALIZATION%></a>
			...
			<%
				...
				N_CT = "①"
				N_NI = "②"
				N_PV = "③"			'NOM_MENU_USING 값에 따라 하단 정보 넘버링 수동 정렬~
				'N_CV = "④"
				N_DPV = "④"
				'N_DCV = "⑥"
				N_GD = "⑤"
				'N_CP = "⑧"
			%>
			<input type="checkbox" name="cCenter" id="cCenter" value="1" <%=isChecked(cCenter,"1")%>><label for="cCenter" style="margin-left:14px;"><%=N_CT%><%=LNG_TEXT_CENTER%></label>
		...
		<div id="search_period" class="cleft" style="<%=SEARCHCSS%>">
			<form name="sfrm" action="T_tree_ss_v11.asp" method="post">
				...
				<input type="hidden" name="cRegdate" value="1">
			...
			<!-- <label><input type="checkbox" name="cPeriodDownPV" value="1" class="input_chk vmiddle" <%=isChecked(cPeriodDownPV,"1")%>><%=LNG_TEXT_TREE_LOWER_PV%></label> -->
...
<%
	...
	Response.Write("		<img src='159.gif' width='80' height='80'>")
...
<%
	If IsArray(arrList) Then
		For i = 0 To listLen
			...
			arrList_SaveCur			= arrList(13,i)			'SaveCur
			...
			MODAL_DATA = "" & _
				...
				"<input type=""hidden"" name=""mi_vname"" value="""&arrList_NominName&""" />" &  _
				"<input type=""hidden"" name=""mi_vid"" value="""&arrList_Nominid&"-"&Fn_MBID2(arrList_Nominid2)&""" />" &  _
				"<input type=""hidden"" name=""mi_meap"" value="""&num2cur(arrList_PeriodPV)&""" />" &  _
			...
			viewP_cNomInfo_1	= "<p class="""&liClass&" cNomInfo"" style="""&cNomInfo_display&""">"&N_NI&" : "&arrList_NominName&"</p>"
			viewP_cNomInfo_2	= "<p class="""&liClass&" cNomInfo"" style="""&cNomInfo_display&""">"&N_NI&" : "&arrList_Nominid&"-"&Fn_MBID2(arrList_Nominid2)&"</p>"
			...
			If i = 0 Then
				...
				Else
					...
					PRINT viewP_cCenter & viewP_cNomInfo_1 & viewP_cNomInfo_2 & viewP_cPeriodPV & viewP_cPeriodCV & viewP_cPeriodDownPV & viewP_cPeriodDownCV & viewP_cGrade & viewP_cCPoint
			...
			Else
				...
				Else
					...
					innerHTML = innerHTML &  viewP_cCenter & viewP_cNomInfo_1 & viewP_cNomInfo_2 & viewP_cPeriodPV & viewP_cPeriodCV & viewP_cPeriodDownPV & viewP_cPeriodDownCV & viewP_cGrade & viewP_cCPoint
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="underPV1">
						...
						<div style="text-align:center;">
							<!-- <%=LNG_TEXT_START_DATE%> --> <input type='text' name='SDATE1' id="SDATE1" value="<%=Date()%>" class='input_text readonly tcenter' size='10' onclick="openCalendar(event, this, 'YYYY-MM-DD');" readonly="readonly">
							~
							<!-- <%=LNG_TEXT_END_DATE%> --> <input type='text' name='EDATE1' id="EDATE1" value="<%=Date()%>" class='input_text readonly tcenter' size='10' onclick="openCalendar(event, this, 'YYYY-MM-DD');" readonly="readonly">
