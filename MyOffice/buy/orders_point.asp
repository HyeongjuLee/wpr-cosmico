...
<%
	...
	If MEMBER_ORDER_CHK > 1 Then Call ALERTS("회원번호당 2회까지만 구매할 수 있습니다","back","")	'▣더화이트
If webproIP <> "T" Then
	If MEMBER_ORDER_CHK = 0 Then Call ALERTS("첫번째 구매는 지사장이 할 수 있습니다.","back","")	'▣더화이트
End If
...
<%
	'▣더화이트 포인트
	If webproIP="T"  And DK_MEMBER_ID2 = 1 Then
		...
		<table <%=tableatt%> class="userCWidth orderTable">
			...
			<%
				...
				For i = 0 To UBound(arrUidx)
					...
					Else
						Call alerts(LNG_CS_ORDERS_ALERT03&"DDD","back","")
					End If
					Call closeRs(DKRSS)
			...
			<tfoot>
				...
				'	End If
					...
					If LAST_PRICE > MILEAGE_TOTAL_A Then Call ALERTS("포인트가 부족합니다111.","back","")
				%>
				<!-- <tr>
