...
<%
	...
	strName                 = pRequestTF_JSON("strName", True)					'pRequestTF_JSON 수정!!
	...
	'A_CardPhoneNum           = pRequestTF_JSON("A_CardPhoneNum", False)		'onoffkorea
...
<%
	If cardCheck <> "T" Then
		PRINT "{""result"":""error"",""message"":""카드인증이 정상처리되지 않습니다.""}"
		Response.End
	End If
