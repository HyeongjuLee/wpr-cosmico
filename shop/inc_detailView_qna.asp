		<table <%=tableatt%> class="userCWidth2 in_qna">
			<colgroup>
				<col width="83" />
				<col width="109" />
				<col width="334" />
			...
			<thead>
				<tr>
					<th><%=viewImg(IMG_SHOP&"/detailQnATh01.gif",54,27,"")%></th>
					<th><%=viewImg(IMG_SHOP&"/detailQnATh02.gif",54,27,"")%></th>
					<th><%=viewImg(IMG_SHOP&"/detailQnATh03.gif",54,27,"")%></th>
					<th><%=viewImg(IMG_SHOP&"/detailQnATh04.gif",54,27,"")%></th>
					<th><%=viewImg(IMG_SHOP&"/detailQnATh05.gif",54,27,"")%></th>
					<th class="last"><%=viewImg(IMG_SHOP&"/detailQnATh06.gif",54,27,"")%></th>
				</tr>
			</thead>
			<tbody>
				<%
