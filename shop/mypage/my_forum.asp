...
<div class="my_scrap">
	...
	<p><%=viewImg(IMG_MYPAGE&"/tit_my_forum.gif",790,35,"")%></p>
	<table <%=tableatt%> class="userFullWidth defaultTable1">
		...
		<%
			...
			arrList = Db.execRsList("DKP_MYPAGE_BOARD_LIST",DB_PROC,arrParams,listLen,Nothing)
			...
			If IsArray(arrList) Then
				For i = 0 To listLen
					...
					PRINT "			<td class=""tleft""><a href=""/cboard/board_view.asp?bname="&arrList(2,i)&"&amp;num="&arrList(1,i)&""">"&arrList(4,i)&"</a></td>"
					PRINT "			<td>"&Left(arrList(8,i),10)&"</td>"
					PRINT "			<td>"&arrList(5,i)&"</td>"
					PRINT "			<td>"&arrList(6,i)&" / "&arrList(7,i)&"</td>"
					PRINT "		</tr>"
				Next
			Else
				PRINT "		<tr>"
				PRINT "			<td colspan=""6"" class=""notdata"">작성하신 게시물이 없습니다.</td>"
				PRINT "		</tr>"
			End If
