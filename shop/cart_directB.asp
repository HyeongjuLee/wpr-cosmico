...
<%
	...
	If gidx = "" Then Call ALERTS(LNG_ALERT_WRONG_ACCESS&"02","GO","/shop")
	...
	For i = 0 To UBound(arrGidx)
		If Not IsNumeric(arrGidx(i)) Then Call ALERTS(LNG_ALERT_WRONG_ACCESS&"03","GO","/shop")
	Next
...
<form name="frm" method="post" action="/shop/order.asp">
