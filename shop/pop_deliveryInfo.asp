...
<%
	'jQuery Modal Dialog
	If Not (checkRef(houUrl &"/shop/pop_deliveryInfo.asp") _
		Or checkRef(houUrl &"/shop/order.asp") _
		Or checkRef(houUrl &"/myoffice/buy/order.asp")) Then
		Call alerts(LNG_ALERT_WRONG_ACCESS,"close_p_modal","")
	End If
%>
<link rel="stylesheet" href="/css/popStyle.css?v2" />
