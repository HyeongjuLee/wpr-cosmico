...
function orderSubmit(f) {
	...
	{		
		...
		f.ECH_bankidx.value				= f.bankidx.value;
		f.ECH_bankingName.value			= f.bankingName.value;
		...
		*/
		...
		f.sndReply.value = f.sndReply.value+"/PG/KSNET/payResult_CS_m.asp";			//아직X
...
function calcSettlePrice() {
	...
	$("#LastAreaID, #mComplexTotal_TXT").text(formatComma(settlePrice));
