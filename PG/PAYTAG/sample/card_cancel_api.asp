...
' 가맹점권한으로 결제취소 실행시는
'loginid         =   "1901110002"       '  필수 : 가맹점 로그인ID	'★webpro 수정!! shopcode값으로 잘못들어가있음.
 loginid         =   "paytag"			 '  필수 : 가맹점 로그인ID	'paytag로 넣어야 정상 취소 됨.
 loginpwd        =   ""						'  blank
...
orgpaydate			=   ""              '   필수 : 원거래 승인일자 ( YYYYMMDD )
orgtranamt			=   ""              '   팔수 : 원거래 승인금액
canceltype			=   "0"             '   필수 : 0-전체잔액취소 / 1-부분취소
req_cancelamt		=   ""              '   필수 : 취소희망금액
