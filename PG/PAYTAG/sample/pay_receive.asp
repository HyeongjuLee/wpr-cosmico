...
<script>
    ...
    _frm.tranno.value 	= "<%=recv_tranno%>";
    _frm.apprno.value 	= "<%=recv_apprno%>";
    _frm.trandate.value 	= "<%=recv_trandate%>";
    _frm.trantime.value 	= "<%=recv_trantime%>";
    _frm.cardno.value 	= "<%=recv_cardno%>";
    _frm.tran_inst.value 	= "<%=recv_tran_inst%>";
    _frm.cardname.value 	= "<%=recv_cardname%>";
	_frm.payer_name.value	= "<%=recv_payer_name%>";
	_frm.payer_hp.value 	= "<%=recv_payer_hp%>";
	_frm.payer_email.value= "<%=recv_payer_email%>";
