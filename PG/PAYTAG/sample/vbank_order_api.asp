...
REQ_BODY_STR =  "tran_amt=" & tran_amt & _
                ...
                "&pay_method=" & server.urlencode(pay_method) & _
                "&vbankcode=" & server.urlencode(vbankcode)
...
If Err.Number = 0 Then
    ...
    If server_status >= 400 And server_status <= 599 Then
        ...
        recv_vbankowner =  oJSON.data("vbankowner")                     '   발급 가상계좌 예금주명
        recv_vbankno    =  oJSON.data("vbankno")                        '   발급 가상계좌 계좌번호
        recv_vbankname  =  oJSON.data("vbankname")                      '   발급 가상계좌 은행명
        recv_orderinfo_expiredt=  oJSON.data("orderinfo_expiredt")                      '   주문서 만기일자 : 초과시 삭제
...
<html>
	...
	<body >
        ...
        <header><img src="./img/paytag.png"> API - 가상계좌발급요청 (카카오알림톡) </header>
