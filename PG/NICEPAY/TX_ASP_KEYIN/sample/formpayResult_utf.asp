...
NICEpay.SetField CLng(PInst),"logpath","D:\PG\NICEPAY\log"           'Log Path 설정
...
NICEpay.SetField CLng(PInst),"BuyerAuthNum",Request("regnumber")					''카드소유주 생년월일(yymmdd)
...
cardQuota       = NICEpay.GetResult((PInst),"CardQuota")            '카드 할부기간
		...
		'나이스페이먼츠 답신내용 추가(2018-02-20~) : PC_TX_ASP\sample\payResult_utf.asp 참조  ================S
		''''''''''''''''''''''''''''''''''''''''''''''''''''''''
		' <결제 성공 여부 확인>
		''''''''''''''''''''''''''''''''''''''''''''''''''''''''
		...
		END IF
		'나이스페이먼츠 답신내용 추가(2018-02-20~) : PC_TX_ASP\sample\payResult_utf.asp 참조  ================E
...
<html>
<head>
<title>NICEPAY PAYFORM RESULT(UTF-8)</title>
<meta charset="UTF-8">
...
<body>
  <div class="payfin_area">
    <div class="top">NICEPAY PAYFORM RESULT(UTF-8)</div>
    <div class="conwrap">
      <div class="con">
