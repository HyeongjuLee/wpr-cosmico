...
<body>
<form name="tranMgr" method="post" action="cancelResult_utf.asp">
    <div class="payfin_area">
      <div class="top">NICEPAY CANCEL REQUEST(UTF-8)</div>
      <div class="conwrap">
        <div class="con">
          <div class="tabletypea">
            <table>
              ...
              <tr>
                ...
                <td><input type="text" name="TID" value="nictest04m01011802221425373326"></td>
              </tr>
              <tr>
                <th><span>취소 금액</span></th>
                <td><input type="text" name="CancelAmt" value="1010"></td>
              </tr>
              <tr>
