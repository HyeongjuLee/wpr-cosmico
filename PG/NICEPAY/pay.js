...
function loadings() {
	...
	loadProg.css({"top":(wHeight/2)-150+"px","left":"45%","margin-left":"0px"});
	//loadProg.css({"top":"38%","left":"45%","margin-left":"-80px"});
	loadingBar.toggle();
}
...
//	if (parseInt(f.totalPrice.value,10) != parseInt(stripComma($("#payArea").text())))
//	{
...
//	});
//	//console.log(	(NumberFormatter.format(2500)) ); /* 2,500.00 */
...
function calcSettlePrice() {
	...
	document.getElementById("viewPoint").innerHTML	= NumberFormatter.format(useCmoney);
