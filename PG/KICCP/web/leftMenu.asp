...
<tr>
	...
	<tr>
		<td height="50" align="center" class="menuTitle">EASYPAY7.0</td>
	</tr>
	<tr>
...
<tr>
	...
	<span id="block1" style="DISPLAY:none; MARGIN-LEFT:0px; CURSOR:hand">
		...
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('normal/order.asp');">결제</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('normal/mgr.asp');">변경</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
...
<tr>
	...
	<span id="block2" style="DISPLAY:none; MARGIN-LEFT:0px; CURSOR:hand">
		...
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('escrow/order.asp');">결제</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
		<tr>
			<td height="20">&nbsp;&nbsp;<img src="./img/go_menu_minus2.gif" border="0">&nbsp;<a href="javascript:f_gotomain('escrow/mgr.asp');">변경</a></td>
		</tr>
		<tr>
	         <td background="./img/dot0001.gif"></td>
		</tr>
