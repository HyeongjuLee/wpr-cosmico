...
<body>
<form name="frm_mgr" method="post" action="../easypay_request.asp">
...
<tr>
    ...
    <tr height="25">
        ...
        <td bgcolor="#FFFFFF" width="300">&nbsp;<select name="mgr_subtype" class="input_F">
    ...
    <tr height="25">
        ...
        <td bgcolor="#EDEDED" width="150">&nbsp;금액(환불 금액)</td>
