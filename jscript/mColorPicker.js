  ...
  $.fn.mColorPicker.drawPickerTriggers = function ($t) {
    ...
    if (hidden) {
      ...
      $('#' + id).css({
        ...
        '<span style="cursor:pointer;" id="icp_' + id + '" class="mColorPickerTrigger"><img src="' + $o.imageFolder + 'color.png" style="border:0;margin:0 0 0 3px" align="absmiddle" class="vmiddle" /></span>'
