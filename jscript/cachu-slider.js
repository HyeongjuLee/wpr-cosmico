  ...
  $.fn.fullpage = function(options) {
      ...
      */
      ...
      FP.reBuild = function(resizing){
          ...
          windowsHeight = $window.height() - headerHeight;  //updating global var
      ...
      */
      ...
      /*robraccu*/
      var headerHeight = $("#fullpage").offset().top;
     /*fine robraccu*/
      
      var windowsHeight = $window.height() - headerHeight;
      ...
      */
      function prepareDom(){
          ...
          windowsHeight = $window.height() - headerHeight;
      ...
      */
      function getDestinationPosition(element){
        ...
        if(typeof elemPosition === 'undefined'){ return; }
      ...
      */
      function getScrollSettings(v){
          ...
          if(options.autoScrolling && !options.scrollBar){
              ...
              scroll.element = 'html, #scroll-body';
          }
