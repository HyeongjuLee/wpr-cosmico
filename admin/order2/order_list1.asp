...
<span style="color:red;font-weight:bold;">주문관리 시스템 최적화 및 변경작업중입니다.</span>
...
'						goBackCancel104 = aImg("javascript:backc102Btn('"&arr_IDX&"')",IMG_BTN&"/btn_order_back102.gif",146,31,"")
				...
				'		print arrUsePoint
						...
						SQL = SQL & " B.[GoodsPrice],A.[orderDtoD],A.[orderDtoDValue],A.[intIDX],B.[GoodsCost],B.[GoodsPrice],A.[orderDtoDDate] "
						...
						If IsArray(arrList1) Then
							For j = 0 To listLen1
								...
								Next
									...
									dGoodsPrice = arrSUBprice * arrSUBea
								PRINT "			</td>"
								PRINT "			<td>"&arrSUBea&"</td>"
								PRINT "			<td>판매가 : "&FormatNumber(dGoodsPrice,0)&" 원<br />옵션가 : "&FormatNumber(doptionPrice,0)&" 원<br /><span style='color:red;'>원가 : "&FormatNumber(arrBuyPrice,0)&"원"
								...
								PRINT "					<option value='date' style='color:red;'"&isSelect("0",arrDtoD)&">배송일자만 입력</option>"
