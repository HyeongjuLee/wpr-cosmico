...
'	SQL = " UPDATE [DK_ORDER] SET [state] = '102', [isDelivery] = 'F', [DeliveryDate] = null WHERE [intIDX] = ?"
	SQL = " UPDATE [DK_ORDER2] SET [state] = '102', [isDelivery] = 'F', [DeliveryDate] = null WHERE [intIDX] = ?"
	arrParams = Array(_
