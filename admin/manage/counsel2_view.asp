...
<%
	...
	Set DKRS = Db.execRs("DKPA_COUNSEL2_VIEW",DB_PROC,arrParams,Nothing)
...
<div class="btn_area"><%=aImgOpt("javascript:submitThisView();","S",IMG_BTN&"/btn_rect_confirm.gif",99,45,"","")%><%=aImgOpt("javascript:returnList();","S",IMG_BTN&"/btn_rect_list.gif",99,45,"","style=""margin-left:7px;""")%><%=aImgOpt("javascript:delThisView();","S",IMG_BTN&"/btn_rect_del.gif",99,45,"","style=""margin-left:7px;""")%></div>
