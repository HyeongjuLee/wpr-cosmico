...
<%
	...
	Set DKRS = Db.execRs("DKPA_BRANCH2_VIEW2",DB_PROC,arrParams,Nothing)
...
<div id="bracn_regist">
	<table <%=tableatt%> class="adminFullTable view table2">
		...
		<tr>
			<td colspan="2" class="title">로드샵 정보</td>
		</tr><tr>
			<th>로드샵 표시</th>
			<td><%=RS_isUse_TF%></td>
		</tr><tr>
	...
	<div class="submit_area">
		<%=aImg("branch2_list.asp?bname="&strBoardName,IMG_BTN&"/btn_rect_list.gif",99,45,"")%>			<%=aImgOpt("branch2_modify.asp?idx="&intIDX&"","S",IMG_BTN&"/btn_rect_change.gif",99,45,"","style=""margin-left:7px;""")%>
		<%=aImgOpt("javascript:delok('"&intIDX&"')","S",IMG_BTN&"/btn_rect_del.gif",99,45,"","style=""margin-left:7px;""")%>
	</div>
</div>

<form name="delFrm" action="branch2Handler.asp" method="post">	
