					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<label><input type="radio" name="popKind" class="vmiddle" value="L" />레이어팝업</label>
								<label><input type="radio" name="popKind" class="vmiddle" value="T" onClick="pageGoto(2,'<%=strNationCode%>');"/>상단팝업</label>
							</td>
						</tr> --><tr>
							<th>팝업타이틀</th>
