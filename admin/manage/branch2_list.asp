...
' ===================================================================
	...
	arrList = Db.execRsList("DKPA_BRANCH2_LIST",DB_PROC,arrParams,listLen,Nothing)
...
<script type="text/javascript" src="/admin/jscript/branch2.js"></script>
</head>
<body>
<!--#include virtual = "/admin/_inc/header.asp"-->
<div id="bracn_regist">
	<form name="sfrm" action="branch2_list.asp" method="post">
		<p class="titles">검색<p>
			...
			<tr>
				...
				<td>
					<select name="SEARCHTERM">
						...
						<option value="strBranchName" <%=isSelect(SEARCHTERM,"strBranchName")%>>로드샵 이름으로 검색</option>
						<option value="strBranchOwner" <%=isSelect(SEARCHTERM,"strBranchOwner")%>>로드샵장 이름으로 검색</option>
					</select>
	...
	<table <%=tableatt%> class="adminFullTable list">
		...
		<tr class="datas">
			...
			<td><%=isMap%></td>
			<td><%=aImg("branch2_view.asp?idx="&arrList(1,i),IMG_BTN&"/btn_gray_detailView.gif",70,22,"")%></td>
		</tr>
		<%
				Next
			Else
		%>
		<tr>
			<td colspan="10" align="center" style="height:150px;">현재 등록된 로드샵이 없습니다.</td>
		</tr>
		<%
			End If
		%><tr>
