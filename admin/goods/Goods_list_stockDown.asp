...
<%
	...
	Select Case UCase(strNationCode)
		CASE "KR" : INFO_MODE = "GOODS3-1-1" : INFO_TEXT = "한국"
		CASE "ID" : INFO_MODE = "GOODS3-1-2" : INFO_TEXT = "인도네시아"
		CASE "TH" : INFO_MODE = "GOODS3-1-3" : INFO_TEXT = "태국"
		CASE "EN" : INFO_MODE = "GOODS3-1-4" : INFO_TEXT = "영문"
		CASE "JP" : INFO_MODE = "GOODS3-1-5" : INFO_TEXT = "일본"
	End Select
...
'	Dim strNationCode	:	strNationCode = pRequestTF("strNationCode",False) : If strNationCode = "" Then strNationCode = ""
...
' ===================================================================
	arrParams = Array( _
		...
		Db.makeParam("@@GoodsStockNum",adInteger,adParamInput,4,10), _
	...
	arrList = Db.execRsList("DKSP_GOODS_LIST_STOCKDOWN",DB_PROC,arrParams,listLen,Nothing)
		...
		<tbody>
			...
			<tr>
				...
				<td class="no_left lh160">
					<span style="color:#ff3300;"><%=PrintCate_E1(Left(arrList_Category,3),Left(arrList_Category,6),Left(arrList_Category,9),"",strNationCode)%></span><br />
				...
				<td class="tcenter">
					...
					<%
						Select Case arrList_GoodsStockType
							Case "N" '수량'
								If arrList_GoodsStockNum < 10 Then
