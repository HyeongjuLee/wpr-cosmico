...
' ===================================================================
	arrParams = Array( _
		...
		Db.makeParam("@isAceept",adChar,adParamInput,1,"F"), _
...
'7[isCSGoods]
			...
			<tr>
				...
				<td class="tcenter">
					...
					<a href="Vendor_Goods_Modify_F.asp?Gidx=<%=arrList_intIDX%>"><img src="<%=img_btn%>/g_list_modify.gif" width="85" height="20" style="padding-bottom:2px;" alt="수정" /></a><br />
