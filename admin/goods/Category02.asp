...
<%
	...
	INFO_MODE = "GOODS6-2-"&DKRS_FA_intSort&""
	INFO_TEXT = DKRS_FA_strNationName


	CATEGORY_NAME01 = "서브카테고리"
%>
<style type="text/css">
...
<div id="category" class="">
	<div class="cleft">
		...
		<form name="regfrm" method="post" action="Category02_Handler.asp"onSubmit="return submitInsert(this);">
	...
	<div class="cleft">
		...
		<form name="modfrm" method="post" action="Category02_Handler.asp">
			...
			<table <%=tableatt%> style="width:720px;">
				...
				<%
					SQL = " SELECT * FROM [HW_SHOP_CATEGORY02] WHERE [isDel] = 'F' ORDER BY [strCateCode] ASC"
...
<form name="mfrm" method="post" action="Category02_Handler.asp">
