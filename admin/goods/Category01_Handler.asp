...
<%
	...
	Select Case MODE
		Case "REGIST"
			...
			Call Db.exec("HWPA_SHOP_CATEGORY01_REGIST",DB_PROC,arrParams,Nothing)
		...
		Case "MODIFY"
			...
			Call Db.exec("HWPA_SHOP_CATEGORY01_MODIFY",DB_PROC,arrParams,Nothing)
			OUTPUT_VALUE = arrParams(Ubound(arrParams))(4)
		...
		Case "USE"
			...
			Call Db.exec("HWPA_SHOP_CATEGORY01_USECHG",DB_PROC,arrParams,Nothing)
			OUTPUT_VALUE = arrParams(Ubound(arrParams))(4)
		...
		Case "DELETE"
			...
			Call Db.exec("HWPA_SHOP_CATEGORY01_DELETE",DB_PROC,arrParams,Nothing)
			OUTPUT_VALUE = arrParams(Ubound(arrParams))(4)

		Case Else
	End Select
	Select Case OUTPUT_VALUE
		Case "FINISH" : Call ALERTS(DBFINISH,"GO","Category01.asp?nc="&strNationCode)
