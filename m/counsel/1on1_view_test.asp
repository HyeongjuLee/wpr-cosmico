...
<div id="counseling" class="cs_view">
	<div class="question">
		...
		<div class="file">
			<a href="javascript:fTrans('<%=FN_HR_ENC(DKRS_strData1)%>','<%=FN_HR_ENC("counsel1")%>');">
				...
				<p><%=BACKWORD(DKRS_strData1)%>파일.jpg</p>
	...
	<%Else%>
		...
		<p class="replyInfo2"><span class="color:#0000cc"><%=LNG_1ON1_FINAL_ANSWER_REGISTRATION%> - <%=DKRS_repDate%></span></p>
		<div class="reply">
			<%=DKRS_strReply%>
		</div>
		<%
		...
		%>
		<div class="replyData">
			<div class="DataS"><%=LNG_TEXT_FILE1%> :
	...
	<div class="button_wrap">
		<a href="1on1_list.asp?page=<%=PAGE%>"><%=LNG_BOARD_BTN_LIST%></a>
	</div>
