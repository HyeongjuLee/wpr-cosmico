 ...
 function createRequest(){
  ...
  if(request == null) alert("계속 팅기네! request 객체 오류");
 	...
 	function chkNameSponsor() {
		...
		var url = 'ajax_tree_ss_v2.asp?sname='+values;
 	...
 	function chkNameVoter() {
		...
		var url = 'ajax_tree_vt_v2.asp?sname='+values;
	...
	//수당조직도 회원검색 (2014-02-18)
 	function chkNameSponsorSUB() {
		f = document.sfrm;
		if (f.sname.value == '')
		{
			alert("검색하실 하선회원의 이름을 입력하셔야합니다.");
		...
		var url = 'ajax_tree_ss_v4_sub.asp?sname='+values;
