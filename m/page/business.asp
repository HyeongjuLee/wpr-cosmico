...
<!--#include virtual = "/m/_include/header.asp"-->
	...
	<%Case "11111"%>
		<p><img src="/m/images/content/business01_2.jpg" width="100%" alt="" /></p>
	<%Case "2"%>
		<link rel="stylesheet" href="/m/css/marketing_plan.css?v0">
				...
				<section>
					...
					<ul>
						<li><%=LNG_BUSINESS_04_30%>
							<ol>
								<li style="text-indent: 0"><%=LNG_BUSINESS_04_31%></li>
							</ol>
						</li>
					</ul>
				</section>
