...
<link rel="stylesheet" href="/m/css/category.css" />
...
<div id="index" class="porel">
	...
	<!-- GOODS LIST START -->
	<div class="index_event porel width100">
		<div id="goods">
			<%
				arrParams = Array(_
					...
					For i = 0 To listLen
						...
						If DK_MEMBER_STYPE = "0" And arrList_isCSGoods = "T" Then
							...
							If Not DKRS.BOF And Not DKRS.EOF Then
								...
								'RS_Req_TF2_FLAG	= DKRS("Req_TF2_FLAG")		'디지비 유지상품
							End If
							Call closeRs(DKRS)
						End If

						stockOn = "<div class=""sellPrice""><span class="""">"&num2cur(arrList_GoodsPrice)&"</span><span class=""font_size08em currency""> "&Chg_CurrencyISO&"</span></div>"
						stockOff = "<div class=""sellPrice""><span class="""" style=""text-decoration:line-through"">"&num2cur(arrList_GoodsPrice)&"</span><span class=""font_size08em""> "&Chg_CurrencyISO&" <span class=""red"">("&LNG_SHOP_DETAILVIEW_33&")</span></span></div>"
				...
				<div class="gArea <%=classNames%>" id="gid<%=i+1%>">
						...
						<div class="img" style="padding-bottom:<%=BOX_RATIO_H%>%;" >
							<div class="tcenter" style="position:absolute; width:100%; height:100%;left:0;top:<%=TOP_RATIO%>%;">
								<%If DK_MEMBER_LEVEL > 0 Then%>
									<a href="detailView.asp?gidx=<%=arrList_intIDX%>"><%=goodsImg%></a>
								<%Else%>
					...
					<div class="textArea" >
						...
						<div class="text_noline comment"><%=arrList_GoodsComment%></div>
						<%End If %>
						<div class="text_noline goodsName"><%=arrList_goodsName%><br></div>
							...
							<table <%=tableatt%> class="width100 gTable" style="width:95%;">
								...
								<%
									If DK_MEMBER_LEVEL > 0 Then		'삭제요청
										...
										PRINT "<tr>"
										'PRINT "		<td class=""price fleft mline""><span>"&num2cur(arrList_GoodsCustomer)&"</span>"&Chg_CurrencyISO&"</td>"
										'PRINT "		<td class=""th""></td>"
										'PRINT "</tr><tr>"
										PRINT "		<td class=""price2 fle ft""><span>"&num2cur(notPrice)&"</span>"&Chg_CurrencyISO&"</td>"
										PRINT "		<td class=""th""></td>"
										PRINT "</tr>"
				...
				<%
					Next
				%>
				<!-- <div class="width100 tcenter fleft" style="margin-bottom:10px;">
					<div class="btn"><a href="/m/shop/category.asp" align="center"><p>더보기</p></a></div>
				</div> -->
				<div class="pagingArea pagingMob5 fleft" style="background:#fff;margin-top:20px;">
