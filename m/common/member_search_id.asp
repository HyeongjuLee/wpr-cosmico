...
<div id="idpw" class="memberWrap">
	<div class="tit"><!-- 아이디찾기 --><%=LNG_TEXT_FIND_ID%><i></i></div>
	...
	<div class="inputWrap width100">
		...
		<div class="mem_btn">
			<input type="button" onclick="search_idcheck();" value="<%=LNG_TEXT_CONFIRM%>"/>
		</div>
	</div>
	...
	<div class="mem_search">
		<div class="inner">
			...
			<i></i>
			<div class="idpw mem"><a href="/m/common/member_search_pw.asp"><%=LNG_TEXT_FIND_PASSWORD%></a></div>
		</div>
	</div>
