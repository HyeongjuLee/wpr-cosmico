...
<%
	...
	If Not (checkRef(houUrl &"/m/common/pop_sponsor.asp") _
...
<div id="pop_search" class="pop_sponsor">
	<form name="pfrm" action="" method="post" data-ajax="false">
		<div id="searchs">
			<input type="text" name="user_id" value="<%=strID%>" class="" />
			<label class="search">
