...
'		Case "KR","MN"
			If Not checkRef(houUrl &"/m/common/joinStep03.asp") Then Call alerts(LNG_ALERT_WRONG_ACCESS,"go","/m/common/joinStep01.asp")
'		Case Else
		...
		'####################################################################
			...
			If snsToken <> "" Then
				...
				If Int(SNS_FAKE_CHECK_CNT) < 1 Then
					Call ALERTS("Data modulation! (SNS)","go","/m/common/joinStep01.asp")
				End If
			End If
