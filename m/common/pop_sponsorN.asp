...
<div id="pop_search" class="width100">
	...
	<table <%=tableatt%> class="width100">
			...
			<tr>
				<th>회원번호</th>
				<td style="text-align:left; padding-left:7px;"><input type="text" name="SponID1" value="<%=SponID1%>" class="input_text" style="width:40%" /> - <input data-theme="w" type="tel" name="SponID2" value="<%=SponID2%>" class="input_text" style="width:40%" /></td>
			</tr><tr>
				<th>회원명</th>
				<td style="text-align:left; padding-left:7px;"><input type="text" name="m_name" value="<%=SponName%>" class="input_text" style="width:90%"  /></td>
			</tr>
			<!-- <tr>
				<th>회원번호</th>
		...
		<table <%=tableatt1%> class="width100" style="margin-top:20px;">
			...
			%>
				...
				<%Else %>
					<span class="tweight red lheight135">후원라인이 모두 등록된 회원입니다.</span>
				<%End If%>
				</td>
			</tr>
			<%
