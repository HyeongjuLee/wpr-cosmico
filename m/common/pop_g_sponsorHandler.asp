...
'Response.end
	...
	Recordtime = Left(nowTime,10) & " "& Right("00"&Hour(nowTime),2) &":"&Right("00"&Minute(nowTime),2) &":"&Right("00"&Second(nowTime),2)
		...
		'Db.makeParam("@Save_OrderNumber",adVarChar,adParamInput,30,chk_OrdNo), _
	arrParams = Array(_
		Db.makeParam("@mbid",adVarChar,adParamInput,20,DK_MEMBER_ID1), _
		Db.makeParam("@mbid2",adInteger,adParamInput,0,DK_MEMBER_ID2), _
	...
	Select Case OUTPUT_VALUE
		...
		Case "FINISH"		: Call ALERTS(LNG_STRTEXT_TEXT03,"o_reloada","/m/buy/order_list.asp")					'정상처리
		'Case "FINISH"		: Call ALERTS("후원인의 회원번호가 "&THISMEMID1&"-"&Fn_MBID2(THISMEMID2)&"로 변경되었습니다.","o_reloada","/m/buy/order_list.asp")
