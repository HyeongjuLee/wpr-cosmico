...
<%
	Response.Redirect "/m/common/pop_voterN.asp"		'추천인 -> 추천인의 후원하선 -> 라인선택으로 변경 (2015-05-07)
...
<div id="pop_search" class="width100">
	<form name="pfrm" action="" method="post" data-ajax="false">
		<table <%=tableatt%> class="width100">
			...
			<tr>
				<th>회원번호</th>
				<td style="text-align:left; padding-left:7px;"><input type="text" name="mbid1" value="<%=strMbid1%>" maxlength="2" class="input_text" style="width:40%" /> - <input data-theme="w" type="tel" name="mbid2" value="<%=strMbid2%>" class="input_text" style="width:40%" /></td>
			</tr><tr>
				<th>회원명</th>
