...
<div id="div_date">
	<form name="dateFrm" action="memberSponsorAll.asp" method="post" data-ajax="false">
...
<div id="member" class="">
	<table <%=tableatt%> class="width100">
		...
		<%
				...
				arrList =  Db.execRsList("HJP_MEMBER_INFOS_ALL_UNDER_SPON",DB_PROC,arrParams,listLen,DB3)
