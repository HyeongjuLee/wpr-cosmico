...
<script type="text/javascript">
	...
	<div id="loadings<%=LINE_CNT%>" class="loadings" style="width:100%; height:100%;position:absolute;display:none;">
		<div id="loading_bg"><img id="loading-image" src="<%=IMG%>/159.gif" width="50"  alt="" /></div>
	</div>
	...
	<div class="fixedTableWrap tcenter" style="">
		<div id="fixedTable">
			...
			<div class="fixedTable_overCell">
				<table id="fTbl_O<%=LINE_CNT%>" <%=tableatt%> >
				</table>
			</div>
		</div>
	</div>
	...
	<div class="pagingArea pagingMob5n">
		<%Call Fn_PageList_UnderSpon_Mob(PAGE,PAGECOUNT	,ori_UnderID1,ori_UnderID2,UnderName,M_Name,SearchCate ,SDATE,EDATE,viewID ,v_LEVEL,v_Sell_Mem_TF,v_LeaveCheck,v_CurGrade,businesscode,LINE_CNT)%>
	</div>
...
<%
	' *****************************************************************************
	' Function Name : Fn_PageList_UnderSpon_Mob
	' Discription : 산하회원정보 AJAX페이징
	' *****************************************************************************
		Sub Fn_PageList_UnderSpon_Mob (ByVal page, ByVal total_page	_
