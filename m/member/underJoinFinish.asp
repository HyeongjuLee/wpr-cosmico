...
<%
	...
	If Not checkRef(houUrl &"/m/member/underJoin02.asp") Then Call ALERTS(LNG_ALERT_WRONG_ACCESS,"back","")
...
'		Call ResRW(strPass		,"strPass")
	...
	'	If SSHCOUNT > 0 Then Call alerts("이미 등록된 회원입니다. 본인이 회원가입을 하지 않았다면 본사로 문의해주세요.","BACK","")
...
'Response.end
	...
	''	R_NationCode = "KR"
		...
		End Select
			...
			'Db.makeParam("@BirthDay",adVarChar,adParamInput,8,Replace(strBirth,"-","")), _
...
'	RESPONSE.End
		Select Case OUTPUT_VALUE
			...
			Case "OVERLAP_NB"	: Call ALERTS(LNG_JS_ALREADY_REGISTERED_MEMBER2&"DD","BACK","")
			...
			Case "FINISH"		: Call ALERTS(LNG_JOINFINISH_U_ALERT_OUTPUT07&"\n\n"&THISMEMID1&" - "&Fn_MBID2(THISMEMID2)&"","go",""&ptshop&"/m/member/member_voter.asp")
