...
<div id="subTitle" class="width100 tcenter text_noline" ><%=LNG_MYOFFICE_CHART_02%></div>
...
'	DK_MEMBER_ID2 = 10001
	...
	If IsArray(arrList) Then
		...
		For i = 0 To listLen
			...
			If i = 0 Then
				PRINT "<li class=""fnode""><p style=""font-weight:bold;"" "&liClass&"><a href=""?sid1="&arrList(5,i)&"&amp;sid2="&arrList(6,i)&""" data-ajax=""false"">"&LNG_TEXT_TREE_TOP&"</a></p><p style=""font-weight:bold;"" "&liClass&"><a href=""?sid1="&arrList(0,i)&"&amp;sid2="&arrList(1,i)&""" data-ajax=""false"">"&arrList(0,i)&"-"&Fn_MBID2(arrList(1,i))&"</a></p><p "&liClass&"><span class=""s320over"">"&LNG_TEXT_NAME&" : </span>"&ThisName&"</p><p "&liClass&"><span class=""s320over"">상태 : </span>"&leaveCheck&"</p><p "&liClass&"><span class=""s320over"">"&LNG_TEXT_REGTIME&" : </span>"&(arrList(4,i))&"</p><!-- <p "&liClass&">구매일 : "&arrList(10,i)&"</p> --><ul id=""T"&TrID&"""></ul></li>"
			Else
