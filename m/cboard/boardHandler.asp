...
'		print inputDate
		...
		If Upload.Form("strPic1") <> "" Then
			strPic1 = uploadImg("strPic1",REAL_PATH("board\OriginalPic"),REAL_PATH("board\pic1"),650,650)
		Else
			strPic1 = ostrPic1
		End If
		If Upload.Form("strPic2") <> "" Then
			strPic2 = uploadImg("strPic2",REAL_PATH("board\OriginalPic"),REAL_PATH("board\pic2"),650,650)
		Else
			strPic2 = ostrPic2
		End If
		If Upload.Form("strPic3") <> "" Then
			strPic3 = uploadImg("strPic3",REAL_PATH("board\OriginalPic"),REAL_PATH("board\pic3"),650,650)
		Else
			strPic3 = ostrPic3
		End If
