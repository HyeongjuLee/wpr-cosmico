...
<%
	...
	SQL = "SELECT COUNT(*) FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intList] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName), _
	...
	SQL2 = "SELECT COUNT(*) FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intList] = ? "
	...
	SQL = "SELECT [strPic] FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intIDX] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName), _
		Db.makeParam("@intIDX",adInteger,adParamInput,4,bidx) _
	)
	...
	SQL = "SELECT [strData1] FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intIDX] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName), _
		Db.makeParam("@intIDX",adInteger,adParamInput,4,bidx) _
	)
	...
	End If
	Call closeRs(DKRS)
	SQL = "SELECT [strData2] FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intIDX] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName), _
		Db.makeParam("@intIDX",adInteger,adParamInput,4,bidx) _
	)
	...
	End If
	Call closeRs(DKRS)
	SQL = "SELECT [strData3] FROM [DK_NBOARD_CONTENT] WHERE [strBoardName] = ? AND [intIDX] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName), _
		Db.makeParam("@intIDX",adInteger,adParamInput,4,bidx) _
	)
	...
	SQL = "SELECT [isPointUse],[intPointWrite],[intPointUpload],[intPointComment],[isPointDelete],[isPointDelComment] FROM [DK_NBOARD_POINT] WHERE [strBoardName] = ?"
	arrParams = Array( _
		Db.makeParam("@strBoardName",adVarChar,adParamInput,50,strBoardName) _
	)
	Set DKRS = Db.execRs(SQL,DB_TEXT,arrParams,Nothing)
