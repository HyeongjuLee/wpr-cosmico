...
<%
	...
	If Not checkRef(houUrl &"/m/mypage/member_outpin_change.asp") Then Call alerts(LNG_ALERT_WRONG_ACCESS,"go","/m/mypage/member_outpin_change.asp")
	...
	Select Case OUTPUT_VALUE
		...
		Case "FINISH"		: Call ALERTS(LNG_MYPAGE_INFO_COMPANY_HANDLER_ALERT09,"go","/m/mypage/member_info.asp")
