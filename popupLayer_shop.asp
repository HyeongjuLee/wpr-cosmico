<%
	'PC 쇼핑몰 레이어 팝업
	SQL = "SELECT * FROM [DK_POPUP] WHERE [useTF] = 'T' AND [popKind] = 'L' AND [isViewCom] ='T' AND [isViewShop] = 'T' AND [strNation] = '"&Lang&"' AND [isViewMobile] = 'F' ORDER BY [intIDX] ASC"
...
<%If imgHeight > 0 And imgHeight > 0 Then%>
