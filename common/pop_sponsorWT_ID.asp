...
<%
	...
	arrList = Db.execRsList("[HJP_MEMBER_SEARCH_SPON_FROM_VOTER_WEBID]",DB_PROC,arrParams,listLen,DB3)
...
<div id="pop_search">
	...
	<div class="content" style="height:410px;">
		...
		<p class="tcenter">
			...
			<input type="text" name="user_id" value="" class="input_text vtop" style="padding:2px 5px;" tabindex="1" />
