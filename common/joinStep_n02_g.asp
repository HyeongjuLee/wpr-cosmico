...
<div id="joinStep" class="common joinStep2">
	...
	<article class="privacy">
		...
		<div class="info">
			...
			<form name="nfrm" method="post" action="" onSubmit="return nameChk2(this)" >
				<div class="box name">
					...
					<div class="con">
						<input type="text" name="M_Name_Last" style="<%=IMES_MODE%>" placeholder="<%=LNG_TEXT_FAMILY_NAME%>" />
						<input type="text" name="M_Name_First" style="<%=IMES_MODE%>" placeholder="<%=LNG_TEXT_GIVEN_NAME%>" />
					</div>
				</div>
				<div class="box birth">
		...
		<div class="btnZone">
			...
			<input type="button" class="promise" value="<%=LNG_TEXT_NEXT_STEP%>" onclick="checkAgree();" />
		</div>
	</article>
</div>
