...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({
	...
	$LOCAL_BEFORE_FIRST : function(sMsg){
		...
		this.htPopupOption = {
			...
			sProperties : "",
			sUrl : "",
			ipath : this.oApp.htOptions.ipath
		};
	 ...
	 */
	makePopupURL : function(ds,slang){
		var sPopupUrl = "./photo_uploader/popup/photo_uploader.asp?slang="+this.oApp.htOptions.I18N_LOCALE+"&ipath="+ds;
