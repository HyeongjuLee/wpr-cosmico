...
'		Response.Cookies("edukin") = ""
'		Response.Cookies("edukin").Domain = ".edukin.co.kr"
'		Response.Cookies("edukin")("DKMEMBERID") = ""
'		Response.Cookies("edukin")("DKMEMBERNAME") = ""
'		Response.Cookies("edukin")("DKMEMBERLEVEL") = ""
'		Response.Cookies("edukin")("DKMEMBERGROUP") = ""
'		Response.Cookies("edukin")("DKMEMBERTYPE") = ""
'		Response.Cookies("edukin")("DKMEMBERDOMAIN") = ""
	...
	If BackUrl = "" Then
		...
		Call alerts(LNG_MEMBER_LOGOUT_ALERT01,"go",backURL)
	Else
		'Response.Redirect "/index.asp"
		Call alerts(LNG_MEMBER_LOGOUT_ALERT01,"go",backURL)
	End If
