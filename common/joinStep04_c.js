...
function vote_idcheck2() {
	openPopup("/common/pop_voterN.asp", "vote_idcheck2", 100, 100, "left=200, top=200");
//	openPopup("/common/pop_voter2.asp", "vote_idcheck2", 100, 100, "left=200, top=200");
}
function spon_idcheck2() {
	openPopup("/common/pop_voterN.asp", "vote_idcheck2", 100, 100, "left=200, top=200");
//	openPopup("/common/pop_sponsor2.asp", "spon_idcheck2", 100, 100, "left=200, top=200");
}

/////////헬씨 후원 라인선택  2013-03-18
function spon_idcheck3() {
	openPopup("/common/pop_sponsor2_Line.asp", "spon_idcheck", 100, 100, "left=200, top=200");
}
	function openzip() {
